...
class AnimalIslandThemeData extends ThemeExtension<AnimalIslandThemeData> {
  ...
  static const AnimalIslandThemeData nesDay = AnimalIslandThemeData(
    ...
    mode: AnimalIslandThemeMode.day,
    primary: Color(0xFFE84828),
    primaryHover: Color(0xFFFF6A3A),
    primaryActive: Color(0xFFA82018),
    primarySoft: Color(0xFFFFC2A8),
    textPrimary: Color(0xFF1B1510),
    textBody: Color(0xFF302015),
    textSecondary: Color(0xFF66422A),
    textMuted: Color(0xFF8A6546),
    textDisabled: Color(0xFF9A7A5A),
    border: Color(0xFF1B1510),
    borderLight: Color(0xFF6B3A1E),
    borderHover: Color(0xFFE84828),
    surface: Color(0xFFE0A060),
    surfaceRaised: Color(0xFFFFD0A0),
    surfaceSoft: Color(0xFFC87838),
    surfaceMuted: Color(0xFF8C4A28),
    pageBackground: Color(0xFF5C94FC),
    pageBackgroundAlt: Color(0xFF9BD8FF),
    success: Color(0xFF00A850),
    successActive: Color(0xFF007038),
    warning: Color(0xFFE8A838),
    warningActive: Color(0xFFB86A20),
    error: Color(0xFFE84828),
    errorActive: Color(0xFFA82018),
    focusYellow: Color(0xFF3C78FF),
    focusYellowDark: Color(0xFF0050B8),
    sidebarActive: Color(0xFFE84828),
    sidebarHover: Color(0xFFC87838),
    buttonShadow: Color(0xFF1B1510),
    inputShadow: Color(0xFF1B1510),
    heroGradientStart: Color(0xFF5C94FC),
    heroGradientEnd: Color(0xFFE0A060),
    codeBackground: Color(0xFF1B1510),
    codeBorder: Color(0xFFFFD0A0),
  ...
  static const AnimalIslandThemeData nesNight = AnimalIslandThemeData(
    gameStyle: AnimalIslandGameStyle.nes8Bit,
    mode: AnimalIslandThemeMode.night,
    primary: Color(0xFFFF6A3A),
    primaryHover: Color(0xFFFF7A4A),
    primaryActive: Color(0xFFE84828),
    primarySoft: Color(0xFF442018),
    textPrimary: Color(0xFFFFFFFF),
    textBody: Color(0xFFFFD0A0),
    textSecondary: Color(0xFFE0A060),
    textMuted: Color(0xFFC87838),
    textDisabled: Color(0xFF765032),
    border: Color(0xFFFFD0A0),
    borderLight: Color(0xFFE0A060),
    borderHover: Color(0xFFFF6A3A),
    surface: Color(0xFF201828),
    surfaceRaised: Color(0xFF342038),
    surfaceSoft: Color(0xFF593028),
    surfaceMuted: Color(0xFF120C18),
    pageBackground: Color(0xFF07123A),
    pageBackgroundAlt: Color(0xFF143C78),
    success: Color(0xFF58D854),
    successActive: Color(0xFF00A850),
    warning: Color(0xFFE8A838),
    warningActive: Color(0xFFB86A20),
    error: Color(0xFFFF6A3A),
    errorActive: Color(0xFFE84828),
    focusYellow: Color(0xFF3C78FF),
    focusYellowDark: Color(0xFF0050B8),
    sidebarActive: Color(0xFFFF6A3A),
    sidebarHover: Color(0xFF593028),
    buttonShadow: Color(0xFF000000),
    inputShadow: Color(0xFF000000),
    heroGradientStart: Color(0xFF143C78),
    heroGradientEnd: Color(0xFF07123A),
  ...
  Map<String, Color> get cardColors => {
    if (isWestworld) ...{
      ...
      'default': surfaceRaised,
      'app-pink': const Color(0xFFFF8A78),
      'purple': const Color(0xFF8C5CC8),
      'app-blue': const Color(0xFF3C78FF),
      'app-yellow': const Color(0xFFE8A838),
      'app-orange': const Color(0xFFE87828),
      'app-teal': const Color(0xFF5C94FC),
      'app-green': const Color(0xFF00A850),
      'app-red': const Color(0xFFE84828),
      'lime-green': const Color(0xFF58D854),
      'yellow-green': const Color(0xFF78C850),
      'brown': const Color(0xFFC87838),
      'warm-peach-pink': const Color(0xFFFF9A78),
...
ThemeData buildAnimalIslandTheme({
  ...
  final baseTextTheme = switch (gameStyle) {
    AnimalIslandGameStyle.nes8Bit => GoogleFonts.mPlusRounded1cTextTheme(
      base.textTheme,
    ),
  ...
  final textFont = switch (gameStyle) {
    AnimalIslandGameStyle.nes8Bit => GoogleFonts.mPlusRounded1c,
